...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    @Override
    public void onBindViewHolder(@NonNull K holder, int position, List<Object> payloads) {
        Log.i("", "走onBindViewHolder1");
    ...
    protected abstract void convert(K helper, T item, @NonNull List<Object> payloads);

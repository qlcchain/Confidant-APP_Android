...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public void onStartAnimator(@NonNull RefreshLayout refreshLayout, int height, int maxDragHeight) {
        ...
        if (progressView.getVisibility() != VISIBLE) {
            ...
            progressView.setPivotX(drawable.getIntrinsicWidth() / 2);
            progressView.setPivotY(drawable.getIntrinsicHeight() / 2);
            ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(progressView, "rotation", 0, 360);

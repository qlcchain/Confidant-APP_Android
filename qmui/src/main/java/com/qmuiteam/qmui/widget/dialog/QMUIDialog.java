...
public class QMUIDialog extends Dialog {
    ...
    public void showWithImmersiveCheck(AppCompatActivity activity) {
    ...
    public void showWithImmersiveCheck() {
        if (!(mBaseContext instanceof AppCompatActivity)) {
            super.show();
            return;
        }
        AppCompatActivity activity = (AppCompatActivity) mBaseContext;

...
public class QMUINotchHelper {
    ...
    public static boolean hasNotch(AppCompatActivity activity) {
        if (sHasNotch == null) {
            if(isNotchOfficialSupport()){
    ...
    public static int getSafeInsetTop(AppCompatActivity activity) {
    ...
    public static int getSafeInsetBottom(AppCompatActivity activity) {
        if (!hasNotch(activity)) {
            return 0;
        }
    ...
    public static int getSafeInsetLeft(AppCompatActivity activity) {
        if (!hasNotch(activity)) {
            return 0;
        }
    ...
    public static int getSafeInsetRight(AppCompatActivity activity) {
        if (!hasNotch(activity)) {
            return 0;
        }
    ...
    private static Rect getSafeInsetRect(AppCompatActivity activity) {
        if(isNotchOfficialSupport()){
            Rect rect = new Rect();

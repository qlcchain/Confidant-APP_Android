...
public class RxAndroidSchedulersHookTest {
    private static final RxAndroidSchedulersHookTest DEFAULT_INSTANCE = new RxAndroidSchedulersHookTest();

    public static RxAndroidSchedulersHookTest getDefaultInstance() {

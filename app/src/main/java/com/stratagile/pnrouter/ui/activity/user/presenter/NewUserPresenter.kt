 ...
 * @Description: presenter of NewUserFragment
 * @date 2019/03/21 19:41:25
 */

class NewUserPresenter @Inject
constructor(internal var httpAPIWrapper: HttpAPIWrapper, private val mView: NewUserContract.View) : NewUserContract.NewUserContractPresenter {

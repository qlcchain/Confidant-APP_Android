...
class PicWeiXinNodeFragment : BaseFragment(), PicWeiXinNodeContract.View, PNRouterServiceMessageReceiver.NodeFileCallback {
        ...
        if(jFileActionRsp.params.retCode == 0)
        {
            when(jFileActionRsp.params.react)
            {
                ...
                3->
                {
                    ...
                    var defaultfolder  = PathUtils.getInstance().getEncryptionWeChatNodePath().toString() +"/"+ souceName

...
class MenuOpreateAdapter(arrayList: ArrayList<FileOpreateType>) : BaseQuickAdapter<FileOpreateType, BaseViewHolder>(R.layout.layout_menu_opreate_item, arrayList) {

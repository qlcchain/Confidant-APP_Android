...
class FileTaskListActivity : BaseActivity(), FileTaskListContract.View, PNRouterServiceMessageReceiver.FileTaskBack {
    ...
    override fun initData() {
        ...
        list.add(TaskFile(UpLoadFile("ccc", true, false, true, 0, 0, 0)))
        list.add(TaskFile(UpLoadFile("ccc", true, false, false, 0, 0, 0)))
        list.add(TaskFile(UpLoadFile("ccc", false, false, true, 0, 0, 0)))
        list.add(TaskFile(UpLoadFile("ccc", false, false, false, 0, 0, 0)))

...
public class ColorPickerView extends View {
    ...
    public ColorPickerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mIndicatorColor = array.getColor(R.styleable.ColorPickerView_indicatorColorPicker, Color.WHITE);

        int or = array.getInteger(R.styleable.ColorPickerView_orientationPicker, 0);

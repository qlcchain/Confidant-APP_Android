...
class FileMenuOpreateAdapter(arrayList: ArrayList<FileOpreateType>) : BaseQuickAdapter<FileOpreateType, BaseViewHolder>(R.layout.layout_attach_opreate_item, arrayList) {
    override fun convert(helper: BaseViewHolder?, item: FileOpreateType?, payloads: MutableList<Any>) {
        KLog.i("")
    }

...
class SplashActivity : BaseActivity(), SplashContract.View {
    ...
    override fun initData() {
        ...
        for (index in 1..1000){
            aayy .append("中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。中方对加拿大司法部就孟晚舟案签发授权进行令表示强烈不满和坚决反对。孟晚舟案不是一起简单的司法案件，而是对一家中国高科技企业的政治迫害。后来的事态发展证明了这一点。加方尽管标榜“法治原则”、“司法独立”，但并不能掩盖其在孟晚舟案上犯下的错误。\n" + "\n" + "从事件所呈现出的明显的政治干预情况看，如果加方真的遵循法治原则、司法独立，加方就应该按照加引渡法的有关条款，拒绝美方引渡请求，立即释放孟晚舟女士。加法庭的最终审理结果将是对加方是否坚持司法独立的试金石。我们将拭目以待。")
        }
        KLog.i("aayy:"+aayy.length)

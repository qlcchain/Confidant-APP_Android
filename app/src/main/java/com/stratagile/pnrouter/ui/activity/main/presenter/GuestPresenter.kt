 ...
 */
class GuestPresenter @Inject
constructor(internal var httpAPIWrapper: HttpAPIWrapper, private val mView: GuestContract.View) : GuestContract.GuestContractPresenter {

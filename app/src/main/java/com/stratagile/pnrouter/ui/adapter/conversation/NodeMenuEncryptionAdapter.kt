...
class NodeMenuEncryptionAdapter(arrayList: MutableList<LocalFileMenu>) : BaseQuickAdapter<LocalFileMenu, BaseViewHolder>(R.layout.nodemenu_encryption_adapter, arrayList) {

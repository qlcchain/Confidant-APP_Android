 ...
 * @Description: presenter of PdfViewActivity
 * @date 2018/10/09 16:03:36
 */
class PdfViewPresenter @Inject
constructor(internal var httpAPIWrapper: HttpAPIWrapper, private val mView: PdfViewContract.View) : PdfViewContract.PdfViewContractPresenter {

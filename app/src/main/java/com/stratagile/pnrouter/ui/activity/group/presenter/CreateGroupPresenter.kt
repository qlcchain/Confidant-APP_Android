 ...
 * @Description: presenter of CreateGroupActivity
 * @date 2019/03/12 15:29:49
 */
class CreateGroupPresenter @Inject
constructor(internal var httpAPIWrapper: HttpAPIWrapper, private val mView: CreateGroupContract.View) : CreateGroupContract.CreateGroupContractPresenter {

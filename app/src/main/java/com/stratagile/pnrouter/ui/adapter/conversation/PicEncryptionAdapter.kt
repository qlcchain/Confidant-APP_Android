...
class PicEncryptionAdapter(arrayList: MutableList<JPullFileListRsp.ParamsBean.PayloadBean>) : BaseQuickAdapter<JPullFileListRsp.ParamsBean.PayloadBean, BaseViewHolder>(R.layout.pic_encryption_adapter, arrayList) {

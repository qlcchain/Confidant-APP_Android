 ...
 * @Description: presenter of CreateLocalAccountActivity
 * @date 2019/02/20 14:14:35
 */
class CreateLocalAccountPresenter @Inject
constructor(internal var httpAPIWrapper: HttpAPIWrapper, private val mView: CreateLocalAccountContract.View) : CreateLocalAccountContract.CreateLocalAccountContractPresenter {

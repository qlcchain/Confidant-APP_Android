...
import com.stratagile.pnrouter.ui.activity.user.component.DaggerTermsOfServiceComponent
...
class TermsOfServiceFragment : BaseFragment(), TermsOfServiceContract.View {

    @Inject
    lateinit internal var mPresenter: TermsOfServicePresenter
...
//        webSettings.setPluginState(WebSettings.PluginState.ON);
    ...
    override fun setupFragmentComponent() {
        DaggerTermsOfServiceComponent
                .builder()
                .appComponent((activity!!.application as AppConfig).applicationComponent)
                .termsOfServiceModule(TermsOfServiceModule(this))
                .build()
                .inject(this)
    }

    override fun setPresenter(presenter: TermsOfServiceContract.TermsOfServiceContractPresenter) {
        mPresenter = presenter as TermsOfServicePresenter
    }

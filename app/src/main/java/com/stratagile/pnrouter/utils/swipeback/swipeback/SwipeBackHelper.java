...
public class SwipeBackHelper extends Handler {
    ...
    public boolean ismIsSupportSlideBack() {
        return mIsSupportSlideBack;
    }

    public void setmIsSupportSlideBack(boolean mIsSupportSlideBack) {
        this.mIsSupportSlideBack = mIsSupportSlideBack;
    }

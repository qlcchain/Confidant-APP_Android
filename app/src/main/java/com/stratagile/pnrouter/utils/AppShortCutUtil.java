...
public class AppShortCutUtil {
     ...
     *
     */
    public static void addNumShortCut(Context context, Class<?> clazz, boolean isShowNum, int num, boolean isStroke) {
...
//            installRawShortCut(context, MainActivity.class, isShowNum, num + "", isStroke);
    ...
    public static void huaweiShortCut(Context context, Class<?> clazz, int num) {
        try{
            KLog.i("设置华为角标");
//            KLog.i(clazz.getName());
            KLog.i(context.getPackageName());
            Bundle bunlde =new Bundle();
            bunlde.putString("package", context.getPackageName());
            bunlde.putString("class", "com.stratagile.pnrouter.ui.activity.main.MainActivity");
    ...
    public static void clearBadge(Context context) {
        addNumShortCut(context, null, false, 0, false);

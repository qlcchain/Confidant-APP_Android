...
public class FriendEntityDao extends AbstractDao<FriendEntity, Long> {
    ...
    public static class Properties {
        ...
        public final static Property FriendLocalStatus = new Property(4, int.class, "friendLocalStatus", false, "FRIEND_LOCAL_STATUS");
        public final static Property AddFromMe = new Property(5, boolean.class, "addFromMe", false, "ADD_FROM_ME");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FRIEND_ENTITY\" (" + //
                ...
                "\"FRIEND_LOCAL_STATUS\" INTEGER NOT NULL ," + // 4: friendLocalStatus
                "\"ADD_FROM_ME\" INTEGER NOT NULL ," + // 5: addFromMe
    ...
    protected final void bindValues(DatabaseStatement stmt, FriendEntity entity) {
        ...
        stmt.bindLong(5, entity.getFriendLocalStatus());
        stmt.bindLong(6, entity.getAddFromMe() ? 1L: 0L);
    ...
    public FriendEntity readEntity(Cursor cursor, int offset) {
        FriendEntity entity = new FriendEntity( //
            ...
            cursor.getInt(offset + 4), // friendLocalStatus
            cursor.getShort(offset + 5) != 0, // addFromMe
    ...
    public void readEntity(Cursor cursor, FriendEntity entity, int offset) {
        ...
        entity.setFriendLocalStatus(cursor.getInt(offset + 4));
        entity.setAddFromMe(cursor.getShort(offset + 5) != 0);

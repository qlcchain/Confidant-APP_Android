...
/** 
 * DAO for table "EMAIL_CID_ENTITY".
*/
public class EmailCidEntityDao extends AbstractDao<EmailCidEntity, Long> {

    public static final String TABLENAME = "EMAIL_CID_ENTITY";

    /**
     * Properties of entity EmailCidEntity.<br/>
    ...
    public EmailCidEntityDao(DaoConfig config) {
        super(config);
    }
    
    public EmailCidEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"EMAIL_CID_ENTITY\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"EMAIL_CID_ENTITY\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, EmailCidEntity entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, EmailCidEntity entity) {
        stmt.clearBindings();
    ...
    @Override
    public EmailCidEntity readEntity(Cursor cursor, int offset) {
        EmailCidEntity entity = new EmailCidEntity( //
    ...
    @Override
    public void readEntity(Cursor cursor, EmailCidEntity entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(EmailCidEntity entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(EmailCidEntity entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(EmailCidEntity entity) {

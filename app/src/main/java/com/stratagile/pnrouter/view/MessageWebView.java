...
public class MessageWebView extends WebView {
    ...
    public void displayHtmlContentWithInlineAttachments(@NonNull String htmlText,
        ...
        setWebViewClient(onPageFinishedListener);
        setHtmlContent(htmlText);
    }

    private void setWebViewClient(@Nullable OnPageFinishedListener onPageFinishedListener) {
        K9WebViewClient webViewClient = K9WebViewClient.newInstance();

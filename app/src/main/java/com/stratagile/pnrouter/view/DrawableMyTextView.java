...
public class DrawableMyTextView extends LinearLayout {
    ...
    public DrawableMyTextView(Context context) {
        super(context);
        init(context);
    }

    public DrawableMyTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
        initTypeArray(attrs);
    }

    public DrawableMyTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

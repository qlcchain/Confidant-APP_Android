...
//            FileLog.e(e);
    ...
    public static void runOnUIThread(Runnable runnable, long delay) {
        if (delay == 0) {
            AppConfig.instance.applicationHandler.post(runnable);
        } else {
            AppConfig.instance.applicationHandler.postDelayed(runnable, delay);
        }
    }

    public static void cancelRunOnUIThread(Runnable runnable) {
        AppConfig.instance.applicationHandler.removeCallbacks(runnable);
    }
